...
public interface OrderMapper {
    ...
    // CORREÇÃO: Forçando o resultado da soma a se transformar em um Long válido para o Builder
    @Mapping(target = "total", expression = "java((Long) (double) (order.getSubTotal() + order.getDeliveryFee()))")
